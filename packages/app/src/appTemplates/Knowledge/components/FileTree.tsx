    ...
    <aside className="flex w-[230px] shrink-0 flex-col border-r border-line-strong bg-canvas-tint">
      <div className="flex shrink-0 items-center justify-between px-3 py-3">
        ...
        <div className="flex gap-1">
          <button type="button" onClick={() => openDialog({ kind: 'new-page', dirRelPath: '' })} className={iconBtn}>
            {t('newPageShort')}
          </button>
          <button type="button" onClick={() => openDialog({ kind: 'new-folder', dirRelPath: '' })} className={iconBtn}>
            {t('newFolderShort')}
          </button>
        </div>
      </div>
