...
TODO(占位): 本 skill 指导 agent 如何维护 `.withy/knowledge/`(项目)与 `~/.withy/knowledge/`(全局)知识库。
...
- **默认写项目库**(`.withy/knowledge/`);只有用户明说「记到全局/我的个人知识库」才动 `~/.withy/knowledge/`。判断:换个项目还成立 → 全局;只对本仓库有意义 → 项目。
