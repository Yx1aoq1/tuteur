...
| 知识库 `knowledge/`(目录+条目 schema+ingest/query/lint)+ `withy-knowledge` skill                                             | 🟡 目录布局(init 建 sources/wiki + 空 index.md/log.md)+ 条目 schema + 维护命令已实现;ingest/query 与 `withy-knowledge` skill 正文未实现 | knowledge.md                     |
