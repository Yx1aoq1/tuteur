...
summary: 'withy 命令族(init/task/next/approve/rewind/hook/knowledge/dashboard/update/uninstall)、缺省人读+--json、数据注册表+per-agent configurator、模板更新。'
inject: index
...
- [[core]] · [[harness]] · [[harness-flow]] · [[decisions]]
