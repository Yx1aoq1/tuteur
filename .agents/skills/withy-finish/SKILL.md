---
name: withy-finish
description: Wrap up a Withy workflow — reconcile the working tree, capture durable lessons into the knowledge base, then complete and archive the task. Produces no artifact of its own; runs on whatever is in the working tree.
---
